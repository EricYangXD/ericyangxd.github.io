...
| 时段             | 是否可挂单                   | 是否可撤单 | 是否可成交                         |
| ---------------- | ---------------------------- | ---------- | ---------------------------------- |
| 9:15–9:20        | 是                           | 是         | 否 （撮合不成交）                  |
| 9:20–9:25        | 是                           | 否         | 否 （撮合不成交）                  |
| 9:25             | 否                           | 否         | 集合竞价一次性撮合成交，产生开盘价 |
| 9:30–11:30       | 是                           | 是         | 是，随时撮合成交                   |
| 午休 11:30–13:00 | 部分券商可挂,不可撤,不可成交 |            |                                    |
| 13:00–14:57      | 是                           | 是         | 是，随时撮合成交                   |
| 14:57–14:59      | 是                           | 是         | 收盘集合竞价                       |
| 14:59–15:00      | 是                           | 否         | 收盘集合竞价                       |
| 收市后           | 否                           | 否         | 否                                 |

涨跌停限制：主板/创业板/科创板一般为 ±10%，ST 类股票为 ±5%，新股上市首日无涨跌停限制（科创板/创业板前 5 日无涨跌停）。
...
分歧是放量，放量是弱，一致是缩量，缩量是强，分歧转一致就是弱转强。买在分歧，就是买在分歧转一致的时候，这就要预判第二天是转强。卖在一致，就是卖在一致转分歧的时候，这就要预判第二天是转弱。

短线交易的关键分歧买点有三个，分别是：1，市场冰点：涨跌家数冰点；2，情绪冰点：包括连板高度、涨跌停家数等；3，板块分歧点：板块爆发后的分歧日。

#### 市场冰点：涨跌家数冰点

通常上涨家数低于 1000 家，市场弱到极致也就是冰点，否极泰来的那个转折点。如果当这个数据出现极值，比如 500 以下或者连续两天都处在冰点区域，则情绪已压抑到极致，这是小概率事件，像最近行情也就是 2023 年 10 月下旬，面临抱团后的退潮，高低切换明显，就是处于这样的局面。一旦出现都会是一个转折点，要么是**大势要反转**，要么是**板块要切换**。这个时候的盘面特点：市场普跌，一般是由于利空刺激或突发状况导致

##### 预判

1. 部分优质股被错杀，存在反包预期。
2. 注意新启动的板块和个股，尤其是指数大跌时逆势抗跌或者走强的板块和个股。

##### 1.操作

冰点日当天低吸这个阶段出现的前排核心股，因为极容易反包上板；或低吸前期的强势股，博弈情绪回暖后强势股的反包（这里通常指前面有自然换手板的个股，二个以上，第一次回踩 10 日线后的低吸反包成功率会稍高些）；如果当时市场还有刚开始的强势连板股，可以做开板后的资金抢筹做回封（2023 年 10 月 20 号的真视通就是一个例子）；也可以做高度股尾盘的回封，博弈次日情绪回暖后高度股的弱转强；或冰点日逆势走强的个股可直接参与，当然参与尽量在早盘 10 点前。

##### 1.逻辑

龙头股一般会提前启动，别的个股下跌时龙头会体现出抗跌属性；龙头股赚钱效应的市场记忆；龙头股具有人气聚集效应，弱势容易被抱团。

##### 2. 第二种情况

这个还是比较好理解，这里面主要汲及的是龙头分歧低吸的战法。这个也是我们实战中最常用得到的，得细说一下。

龙头股的分歧：

龙头股人气很高，是短线资金追逐的宠儿，有时候会直接高开秒板，或者一字板。但它也会遇到多空分歧，导致开盘价很低，或者盘中被砸，这就给了场外资金低吸入场的机会。
...
通常主板个股低于 3%的开盘价，创业板低于 5%，都可以看作是低吸位。有时也会水下开盘。很多时候我们看到竞价压那么低，就感觉这只股要大跌，主观上先放弃了。其实不是的，龙头股低开，有预期差，低吸资金的风险回报比很高，反而更有诱惑力。

如果盘中有场内资金获利结账，把股价砸下来，也会产生股价的剧烈波动，制造盘中的相对低点。这种时候需要看低点的承接，来判断是否能上车。

相对而言，我更喜欢开盘不破趋势的低点机会，可以从开盘资金抢筹的程度，来判断个股强度。

分歧的买点有两个，一个是低吸，一个是打板。低吸是为了博弈大长腿，打板是为了确定性。买入分歧，就是为了当天或者第二天的那个弱转强，形成一致，这样你就把握了主动。

##### 分歧低吸的买点：

1. 如果看好龙头股的行情没有结束，竞价出现低点可以直接挂单买入，这种买点的前提是龙头股没有出现重大利空，所在板块仍有上涨的催化剂，比如一早有看到板块内有一字的首板或连板大单封死，集合竞价的价格从 9:20 到 9:25 不断拉高也就是竞价弱转强。而且当天大盘没有大跌的风险。如果大盘指数处于持续下跌的通道，就要提防第二天不一定会有溢价，那最好的方法是管住手，空仓避险。
...
因为分时股价不断抬高，有时踩不到分时均线就拉上去了，说明资金在抢，筹码供不应求。越是明牌的龙头股会拉得更快，往往早盘几分钟或半小时就完成了开盘抢筹，拉升、回踩、涨停等一系列动作。所以，比拼反应力和手速。

如果一开盘低开后直接被核，分时回都不回头，说明承接非常差，这种情况肯定不能去了。

##### 龙头首次分歧的注意事项！

龙头不会在第一次分歧时死掉，一般在分歧日次日会有个转强的过程。所以，在分歧日进行介入，如果次日转强不能封板，就冲高卖出；如果成功封板，等待再次转弱后卖出。

龙头首次分歧的核心，首先，一定要是板块龙头，一般要求所属热点板块的领涨股，在首板或二板的时候，板块效应要达到 5 只以上。
...
板块高潮日；特点：说明当天是普涨行情，龙头大涨、跟风齐涨。

高潮日怎么参与？

1. 只能参与前排核心
2. 市场趋势中军，或做辨识度极高的个股分歧低吸或打板
3. 参与最高板的回封
4. 或不参与，持有现金等待更好的机会；

预判：次日容易分化。强者恒强，弱者淘汰或冲高回落。

如何操作？去弱换强处理，将手里的跟风股高抛，可以有效避免次日的调整。同时提前回笼资金为调仓进龙头做先手。如果是大题材，板块在刚开始大涨后，正常换手后接着上涨，走趋势为主。如果多次分歧转一致，越后面越难参与赚到钱。

板块高潮日，还有一种情况是预判次日主线分歧时，次主线提前出来蹦跶一下，也就是说次主线存在的意义就是在主线分歧的时候顶出来，保持连板高度或者连板梯队完整性，防止情绪退潮。

大家看下 2023 年 10 月 9 号的案列：华为主线高潮，预判 10 月 10 日也就是次日华为大概率是分歧，那么主线分歧，次主线就能顶出来。大家回顾一下最近贝肯能源在 2023 年的 10 月 9 日出现的 4 板，同身位的有好上好和华映股份都是 4 板，比他们高的是 8 板的精伦电子，后排的 3 板和 2 板出现了批量的华为概念涨停票，保持连板高度或者连板梯队完整性，防止情绪退潮。这里有一个重要逻辑就是：连板股首次弱转强的成功率比二次弱转强的概率高很多，贝肯在 3 进 4 已经完成了一次弱转强，那么 4 进 5 的弱转强通常就是兑现的时候。

都说买在分歧，卖在一致，其实只是说了半句话，所以大家无法理解，我理解整句话应该是这样子的，分歧转一致买入持有，一致转分歧后再卖出 ，这样大家就好理解了，看不懂的多悟就明白了。

#### 买在分歧（看多方），耐心持有，等待一致，卖在新的分歧（看空方）

当市场处于分歧状态时，如果你是看多的一方，就可以制定一个买入计划，可以单笔，也可以分笔，但都是在分歧状态下买入，等待基本面看多逻辑的兑现，股价用一致性的走势来实现利润，这样是不是更容易理解了。（结合下图更好理解）

![分歧买入一致卖出](https://cdn.jsdelivr.net/gh/EricYangXD/vital-images/imgs/20250628112302138.webp)
当公司进入新的分歧时，你需要重新检视自己看多的逻辑是否有变化，没有，就继续持有；如果有，就卖出这一笔交易。

#### 关注在分歧（看多方），重仓在一致，卖在新的分歧（无论看空看多）

第二种情况与第一种情况不同，第一个不同是加仓点的不同；第二种情况在市场分歧状态时，并不急于买入，而是等待市场进入“一致性”时，第一时间快速加仓。第二个不同是进入“新分歧”的应对不同，第一种情况要视逻辑是否变化而决定卖出还是继续持有，第二种情况只要是分歧，就要卖出，即不参与盘整走势。

![重仓一致分歧跑路](https://cdn.jsdelivr.net/gh/EricYangXD/vital-images/imgs/20250628113756476.webp)
...
卖点也是交易系统中的关键环节，俗话说会买的是徒弟，会卖的是师父，只有正确地掌握合适的卖点，才能确保利润。
...
1. 分批操作，因为在博弈的市场中没有神，个股具体能涨多高很难精准预判，分批操作是最适合小散，我平时在解盘也是这么教的。
...
5. 根据大盘强弱走势研判，结合个股盘口，以及盘中强弱表现，灵活操作。需要丰富的实战经验，一定要具备一定的盘感能力；我在解盘经常说的就是，你要是先手买了一只票，按照正常逻辑次日至少是高开一点或低开幅度小再拉起，但如果直接就砸下去超过 5 个点，你该怎么办？是不是要顺势先卖出一些仓位，等分时有向上打时再接着减些仓位，然后观察分时走势如果可以平稳还好，如若不行，趋势有拐头向下的可能那就都卖了。看看最近 2023 年 10 月 18 日硕贝德的走势就知道了，前面走了一波主升，17 号当天冲高回落走势，我是尾盘去低吸博弈资金次日回流，但是我预判错了，次日这一天直接就开始变天了，分时稍有抵抗后就一去不回头了。一开盘就往下杀，顺势卖出，操作上可以分批减持，分时如果有向上可以稍微观察一下，也可以选择继续减仓操作，直到发现无力回天，趋势拐头向下再放弃，全部抛售。

#### 再重点强调一些细节

1. 就是在弱市行情下，很多个股在面对前高压力位时，一般会有回踩，很难一下就冲过去，那么在高开上冲时止盈部分筹码是非常正确的选择；尤其是 2023 年 10 月下旬这边，市场走势比较恶劣，即当天封板的票或封板不坚绝又炸板的票，很多都第二天会大幅低开，闷杀打板、半路等活跃资金，所以当天有急拉升不能封板的也可以顺势减，越早涨停的越稳一些，越迟涨停的越容易开板或次日被砸。像我 2023 年 10 月 13 号低吸的光弘科技，当时趋势好好的，一早我低吸时也顺势就拉板了，但后面遭到先手潜伏盘的砸盘，到尾盘只收涨了 6 个多点，我意识到这样次日肯定是要低开的，所以我立马选择抛售，大家不要心存幻想，有多少人是看着跌想着去补仓的，试想着要是没有跟我这样的手起刀落，做到知行合一，而选择不断的去补仓，只会让你身心疲累，越补越重仓，越亏越多，深陷泥潭无法自拔。一开盘就不及预期往下砸，分时毫无抵抗能力，一直水下运行，只能放弃幻想早跑早好。
2. 缩量上涨过程中，一旦再次放量，就要格外小心，及时止盈，把肉吃到嘴里；大家可以选择冲高分批止盈。现在的炒股环境不比以前，现在动不动就是砸盘，所以，手中的个股先要自已做个预判，只要环境不好还有上冲的动力，就可以止盈部分仓位先；有了一部份收割的利润在手，可以耐心再观察一下是否破均线，一旦跌破均线就选择全部止盈策略，如果不破均线，环境还有转暧的预期，那就顺势做 T；如果次日环境或场内情绪再次变化，再选择抛售最后的底仓。
3. 我们炒股不求买在最低点，卖在最高点，但求常赚；股票买进前可预先这只个股的止盈、止损位，到心理价位即离场，及时离场后还在上涨，也不要懊悔轻易去改动自己预先设置的止盈、止损位，因为场内资金是一个不断博弈的过程，无法那么精准做到极致，毕竟股市中的钱是赚不完的。
...
市场无非两件事：经济好不好，通胀高不高。这两点组合起来，市场大致会经历四种情况：
...
一阳穿三线：指的是低位爆量，实体阳线 K 线穿过了 5 日、10 日、20 日、60 日、120 日、250 日中的任意三根及以上均线。突破均线压力。注意结合股价低位、成交爆量突破来看。

### 天眼地量战法

1. 均线交叉形成“天眼”：5 日均线（短期趋势）短暂下穿 20 日均线（中期趋势）后快速回升，形成闭合的“眼睛”状结构，眼睛越大越好。
2. 成交量萎缩至“地量”：同时成交量需萎缩至近期最低水平（通常为顶部天量的 20%以内），表明抛压衰竭，市场情绪进入冰点，主力尚未出货。
3. K 线底部有长下影线特征：日 K 线常伴随下影线，显示股价下跌后快速收回，止跌信号清晰明确。
4. 回调幅度与时间：回调幅度不超过 15%，时间不超过 30 天，防止趋势走坏。
5. 趋势确认：20 日均线必须持续上行，若走平或向下，即使出现”天眼地量”也要警惕主力诱多。优先选择逆势抗跌或横盘整理、强于大盘的个股。
6. 上车时机：形态形成当日即可上车，但需结合量能和分时图确认突破的有效性。出现一样穿多线且放倍量为优先。

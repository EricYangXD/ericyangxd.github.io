...
- [Section 2: Getting Started](#section-2-getting-started)
  ...
  - [Why is `React.FC` discouraged? What about `React.FunctionComponent`/`React.VoidFunctionComponent`?](#why-is-reactfc-discouraged-what-about-reactfunctioncomponentreactvoidfunctioncomponent)
  - [Using `React.VoidFunctionComponent` or `React.VFC` instead](#using-reactvoidfunctioncomponent-or-reactvfc-instead)
  - [Minor Pitfalls](#minor-pitfalls)
  - [Hooks](#hooks)
  - [useState](#usestate)
  - [useReducer](#usereducer)
  - [Usage with `Reducer` from `redux`](#usage-with-reducer-from-redux)
  - [useEffect / useLayoutEffect](#useeffect--uselayouteffect)
  - [Solution to the above example](#solution-to-the-above-example)
  - [useRef](#useref)
  ...
  - [Alternative: Asserting a tuple return type](#alternative-asserting-a-tuple-return-type)
  ...
  - [Why annotate `state` twice?](#why-annotate-state-twice)
  - [No need for `readonly`](#no-need-for-readonly)
  ...
  - [Misc Discussions and Knowledge](#misc-discussions-and-knowledge)
    - [Why does React.FC break defaultProps?](#why-does-reactfc-break-defaultprops)
    - [TypeScript 2.9 and earlier](#typescript-29-and-earlier)
  - [Typing Component Props](#typing-component-props)
  - [Basic Prop Types Examples](#basic-prop-types-examples)
  - [Useful React Prop Type Examples](#useful-react-prop-type-examples)
    - [Small `React.ReactNode` edge case](#small-reactreactnode-edge-case)
    - [JSX.Element vs React.ReactNode?](#jsxelement-vs-reactreactnode)
  ...
  - [Forms and Events](#forms-and-events)
    - [Why two ways to do the same thing?](#why-two-ways-to-do-the-same-thing)
    - [List of event types](#list-of-event-types)
  - [**What about `InputEvent`?**](#what-about-inputevent)
  - [Context](#context)
  - [Basic Example](#basic-example)
  - [Extended Example](#extended-example)
    - [Mutable Context Using a Class component wrapper](#mutable-context-using-a-class-component-wrapper)
  - [forwardRef/createRef](#forwardrefcreateref)
    - [Side note: the `ref` you get from `forwardRef` is mutable so you can assign to it if needed.](#side-note-the-ref-you-get-from-forwardref-is-mutable-so-you-can-assign-to-it-if-needed)
  - [Portals](#portals)
  - [Using hooks](#using-hooks)
  - [Context of Example](#context-of-example)
...
- [Troubleshooting Handbook: Types](#troubleshooting-handbook-types)
  ...
  - [Using Partial Types](#using-partial-types)
    - [Minor caveats on using `Partial`](#minor-caveats-on-using-partial)
...
- [My question isn't answered here!](#my-question-isnt-answered-here)
  - [Contributors](#contributors)
        <!--START-SECTION:setup-toc--> - [Prerequisites](#prerequisites) - [VS Code Extensions](#vs-code-extensions) - [React + TypeScript Starter Kits](#react--typescript-starter-kits) - [Import React](#import-react) - [Video Tutorial](#video-tutorial)<!--END-SECTION:setup-toc-->
-   [Section 2: Getting Started](#section-2-getting-started)
    -   [Function Components](#function-components)
    -   [Hooks](#hooks)
    -   [Class Components](#class-components)
...
Have a look at the 7-part ["React Typescript Course"](https://www.youtube.com/watch?v=PL1NUl7fQ2I&list=PLG-Mk4wQm9_LyKE5EwoZz2_GGXR-zJ5Ml) video series below for an introduction to TypeScript with React.

![image](https://i.imgur.com/IIG0Xu9.jpeg)
...
2. We can write a helper function called `createCtx` that guards against accessing a `Context` whose value wasn't provided. By doing this, API instead, **we never have to provide a default and never have to check for `undefined`**:
    ...
    export const [useCurrentUserName, CurrentUserProvider] =
    	createCtx<string>();
